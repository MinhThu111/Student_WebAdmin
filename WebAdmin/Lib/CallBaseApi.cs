...
namespace Student_WebAdmin.Lib
{
    ...
    public class CallBaseApi : ICallBaseApi
    {
        private readonly IBase_CallApi _base_CallApi;
        private const string _factoryName = "base";

        public CallBaseApi(IBase_CallApi base_CallApi)
        {
        ...
        {
            _base_CallApi._factoryName = _factoryName;
            return _base_CallApi.PutResponseDataAsync<T>(url, xwwwFormUrlEndcoded, accessToken);
        }
    }
}
