...
jvm.AbstractShapeElement.mergeStyles = function(styles, Studenttyles){
  var key;

  Studenttyles = Studenttyles || {};
  for (key in Studenttyles) {
    if (Studenttyles[key] === null) {
      delete styles[key];
    } else {
      styles[key] = Studenttyles[key];
    }
  }
}/**
